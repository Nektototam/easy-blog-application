...
describe('Authors Management Delete Component', () => {
  let comp: AuthorsDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, AuthorsDeleteDialogComponent],
      providers: [NgbActiveModal],
    })
      .overrideTemplate(AuthorsDeleteDialogComponent, '')
      .compileComponents();
