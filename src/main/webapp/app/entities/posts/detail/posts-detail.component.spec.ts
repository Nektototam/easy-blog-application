...
describe('Posts Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [PostsDetailComponent, RouterTestingModule.withRoutes([], { bindToComponentInputs: true })],
      providers: [
        provideRouter(
          [
            {
  ...
  describe('OnInit', () => {
    it('Should load posts on init', async () => {
      ...
      // THEN
      expect(instance.posts).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
  ...
  describe('byteSize', () => {
    it('Should call byteSize from DataUtils', () => {
      ...
      const fixture = TestBed.createComponent(PostsDetailComponent);
